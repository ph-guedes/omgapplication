...
import com.example.omgapplication.databinding.FragmentViewReportBinding
...
class ViewReportFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val viewReportViewModel =
            ViewModelProvider(this).get(ViewReportViewModel::class.java)
